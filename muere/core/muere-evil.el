...
(use-package evil
  ...
  ;; EWM: las surfaces usan emacs state, EWM intercepta desde su keymap
  ...
  (define-key evil-emacs-state-map  (kbd "Q") 'muere/other-monitor)
  (define-key evil-normal-state-map (kbd "Q") 'muere/other-monitor)
  (define-key evil-motion-state-map (kbd "Q") 'muere/other-monitor)
